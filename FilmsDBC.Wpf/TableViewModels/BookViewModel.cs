    ...
    public class BookViewModel : BaseViewModel<Book>
    {
        ...
        public RelayCommand AddToPriorityCommand
        {
            get
            {
                ...
                {
                    PriorityBooksTable priorityBooks = TableCollection.GetTableByTableType<PriorityBooksTable>();
                    if (!priorityBooks.ContainsBook(Model))
                    {
        ...
        public RelayCommand UpInCategoryIDCommand
        {
            get
            {
                ...
                {
                    BookCategoriesTable categories = TableCollection.GetTableByTableType<BookCategoriesTable>();
        ...
        public RelayCommand DeleteBookCommand
        {
            get
            {
                ...
                {
                    BooksTable booksTable = TableCollection.GetTableByTableType<BooksTable>();
